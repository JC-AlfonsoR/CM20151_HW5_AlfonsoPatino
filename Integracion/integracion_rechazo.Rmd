...
integral_rechazo <- function(func, x_min, x_max)
  {
    ...
    #número, mayor exactitud tendrá el valor calculado de la integral.
    n_points <- 10000
    ...
    #suficientemente pequeño si es menor a 1/n_points, es decir a 1 sobre el número de puntos aleatorios
    #generados en cada eje.
    if (x_max == "inf")
      {
